...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `example-token-not-a-real-credential` | `QR-ABCD-2345` | answer-v1 | 1 | active |
| 2 | `example-token-2-not-a-real-credential` | `QR-EFGH-6789` | 学术英语理工Unit 1 202409 | 4 | active |

## 文件版本

| version_id | binding_id | 版本 | 文件名 | 字节数 | SHA-256 | 文件存在 |
| ---: | ---: | ---: | --- | ---: | --- | --- |
| 1 | 1 | 1 | `answer-v1.txt` | 18 | `<sha256-redacted>` | 是 |
| 2 | 1 | 2 | `answer-v2.txt` | 18 | `5dd3626afff707ea138133eb2dba8cc50e8ac34420d1b20659c55251c7a60b87` | 是 |
| 3 | 2 | 1 | `学术英语理工Unit 1 202409.pdf` | 254738 | `<sha256-redacted>` | 是 |
| 4 | 2 | 2 | `作业1.pdf` | 183211 | `<sha256-redacted>` | 是 |
...
| 入口 | 实际 SHA-256 | 结果 |
| --- | --- | --- |
| `/r/example-token-not-a-real-credential` | `<sha256-redacted>` | 与 current version 1 一致 |
| `/r/example-token-2-not-a-real-credential` | `<sha256-redacted>` | 与 current version 4 一致 |
| `/r/6e69.../versions/1` | `<sha256-redacted>` | 一致 |
| `/r/6e69.../versions/2` | `5dd3626afff707ea138133eb2dba8cc50e8ac34420d1b20659c55251c7a60b87` | 一致 |
| `/r/df82.../versions/3` | `<sha256-redacted>` | 一致 |
| `/r/df82.../versions/4` | `<sha256-redacted>` | 一致 |
